...
#### （2）状态转换
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240509150939.png)
- **就绪态 ---> 运行态**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240509155911.png)
...
- 形成**多对一模型**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511144229.png)
...
- 形成**一对一模型**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511145234.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511145328.png)
##### 1）多对一模型
...
#### （2）调度的层次
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511155616.png)
##### 1）高级调度（作业调度）
...
##### 4）三种调度的联系
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511162031.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511160742.png)
- **组成**：
...
6. 恢复处理机上下文
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240510140821.png)
...
- $利用率=\frac{忙碌的时间}{总时间}$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511172934.png)
**注意**：计算作业完成时间时，要注意 CPU 与设备、设备与设备之间时可以并行的

#### （2）系统吞吐量
- 表示单位时间内 CPU 完成作业的数量
- $系统吞吐量=\frac{总共完成了多少作业}{总共花了多少时间}$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511173354.png)
...
##### 2）算法规则
- 按照作业/进程到达的先后顺序进行服务
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511180250.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511181013.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511181127.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240511182054.png)
...
#### （8）常见算法的对比
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512142602.png)
...
- 每次只允许一个进程进入临界区
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512153946.png)
- **违背“空闲让进”**

##### 2）双标志先检查法
- 设置一个布尔型数组 flag，数组中各个元素用来**标记各进程想进入临界区的意愿**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512154236.png)
- **违背“忙则等待”**【进入区“检查”后，“上锁”前可能发生进程切换】

##### 3）双标志后检查法
- 先“上锁”，后“检查”，避免上诉问题
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512154546.png)
- 解决“忙则等待”
- **违反“空闲让进”和“有限等待”**，会导致饥饿现象

##### 4）Peterson 算法
- 利用 flag 解决互斥访问问题，利用 turn 解决饥饿问题
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512154830.png)
- **违反“让权等待”**

#### （2）硬件实现方法
##### 1）中断屏蔽法
- 关中断：防止其他进程进入临界区
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512155752.png)
- **优点**：简单、高效
- **缺点**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512160354.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512160840.png)
- **优点**：
	- 简单，容易验证其正确性
	- 适用于多处理机系统
...
- 使用互斥锁解决经典同步问题
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512161756.png)
- **优点**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512164712.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512164729.png)
- **P 操作**【wait () 原语】：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512181655.png)
...
- **在“前操作”之后执行 V (S)**
- **在“后操作”之前执行 P (S)**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512182102.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512182149.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512182327.png)
...
- **关系分析**：
	...
	- 生产者和消费者之间相互协作，是同步关系
- **整理思路**：确定 P、V 操作的大致顺序
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512183649.png)
- **信号量设置**：
	- 互斥信号量：mutex 初始值 1，用于控制互斥访问缓冲池
	- 同步信号量：full 初始值 0，表示非空缓冲区（产品）的数量
	- 同步信号量：empty 初始值 n，表示空闲缓冲区的数量
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512184149.png)
- **注意**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512190651.png)
...
- **与信号量的不同点**：
	...
	- 信号量有值，这个值反映了剩余资源数
	- 在管程中，剩余资源数用共享数据结构记录
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512190728.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512142452.png)
...
#### （2）银行家算法
- **详见王道书 25 版 p152**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512145511.png)

- **例题**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512145649.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512145700.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512145725.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240512150402.png)
- 简化资源分配图可检测系统状态是否为死锁：
