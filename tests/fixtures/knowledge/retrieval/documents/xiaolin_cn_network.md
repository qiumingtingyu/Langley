...
- **注意**：
	...
	![image-20231112201120216](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112201120216.png)
...
![image-20231112115609269](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115609269.png)
- **特点**：
	1. 提供了**可靠的通信功能**
	2. 通信链路的**建立和拆除需要时间开销**：
		- 对长时间、频繁的数据交换效率高
...
![image-20231112115700164](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115700164.png)
- **特点**：
	1. 发送分组前**不需要建立连接**
...
- **软件定义网络 SDN**： 
	...
	- **远程控制器**：
		...
		![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713140024.png)
...
- 一个 IP 分组【IP 数据报】由首部和数据部分组成：
	...
	![image-20231112202241515](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202241515.png)
...
+ **总长度**：
	...
	![image-20231112202321669](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202321669.png)
+ **标识**：
...
+ **协议**：占 `8` 比特，指明 `IPv4` 数据报的**数据载荷是何种协议数据单元 PDU**  
	![image-20231112202434619](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202434619.png)
- **首部检验和**：
	...
	![image-20231112202448449](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202448449.png)![image-20231112202457215](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202457215.png)![image-20231112202502811](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202502811.png)
...
- **最大传送单元 MTU**：
	...
	- 片在目的地的网络层被重新组装
	![image-20231119113201227](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119113201227.png)

**举例**
![image-20231112202209562](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202209562.png)

![image-20231112202517390](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202517390.png)

![image-20231112202522679](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202522679.png)
...
![image-20231112202543225](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202543225.png)
- 无论哪一类 IP 地址，都由**主机号**和**网络号**组成
	...
	- 网络号：
		...
		![image-20231119091720276](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119091720276.png)

- **IPv4 地址的表示方法——点分十进制表示方法** 
![image-20231112202606246](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202606246.png)

#### （2）早期 IPv4 编址：分类编址
- A 类、B 类和 C 类地址都是**单播地址**，只有单播地址可以**分配给网络中的主机【或路由器】的各接口**
![image-20231112202629555](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112202629555.png)
...
![image-20231112203240946](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203240946.png)

**例题**
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119092753013.png)

- **IP 地址的重要特点**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713152856.png)
...
- **注意**：
	...
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713161049.png)
- **网络地址与端口号转换 NAPT：
...
- **两级 IP 地址的缺点**：
	...
	- 两级的 IP 地址不够灵活
	![image-20231112203443740](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203443740.png)
- **划分子网的基本思路**：
...
![image-20231112203514118](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203514118.png)

![image-20231112203520882](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203520882.png)
- **在使用子网掩码的情况下**：
...
![image-20231119095411712](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119095411712.png)

**举例**
![image-20231112203543628](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203543628.png)

![image-20231112203550632](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203550632.png)

#### （3）无分类编址 CIDR
- **无分类域间路由选择 CIDR**：
	- 消除了传统的 `A` 类、`B` 类和 `C` 类地址，以及划分子网的概念，因此可以更有效的分配地址空间
	- 使用 **CIDR 记法**：在 `IPv4` 地址后面加上斜线"`/`"，在**斜线后面写上网络前缀所占比特数量**
![image-20231112203601599](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203601599.png)

![image-20231112203617081](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203617081.png)
...
- 只要知道 CIDR 地址块中的任何一个地址，就可以知道：
	...
	- 地址掩码
![image-20231112203640735](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203640735.png)
...
![image-20231112203710011](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203710011.png)
- **最长前缀匹配**：
...
![image-20231112203720992](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203720992.png)

![image-20231112203726360](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203726360.png)

![image-20231112203733348](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203733348.png)

#### （5）子网划分的应用
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713165153.png)
##### 1）采用定长的子网掩码
- 使用同一个子网掩码来划分子网
- 子网划分方式不灵活，只能划分出 2^n 个子网
- 每个子网所分配的 IP 地址数量相同，容易造成 IP 地址浪费
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713165622.png)

##### 2）采用变长的子网掩码
- 使用不同的子网掩码来划分子网
- 子网划分方式灵活：可以按需分配
- 每个子网所分配的 IP 地址数量可以不同，尽可能减少对 IP 地址的浪费
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713170233.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713165851.png)

**例题**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240713170358.png)
...
1. 源主机**判断目的主机和自己在同一个网络**：
	...
	- 若两个网络号不相等，则**间接交付**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714142826.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714142959.png)

2. 间接交付时，主机**选择路由器交付 IP 数据报**：
	- 设置**默认网关**【路由器】：当路由表中**查不到数据时**会将数据发往的路由器端口 `IP` 地址
![image-20231112201604731](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112201604731.png)
...
![image-20231112201624869](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112201624869.png)

2. 基于 **IP 数据报首部中的目的 IP 地址在路由表中进行查找**：
	- 若找到匹配的路由条目，则按该路由条目的指示进行转发
	- 否则丢弃该 IP 数据报，并向发送该 IP 数据报的源主机发送差错报告
![image-20231112201642867](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112201642867.png)
- **注意**：
...
- **广播 IP 数据报的情况**：
![image-20231112201654291](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112201654291.png)
...
- 封装位置：
![image-20231112204031759](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204031759.png)

- 数据报传输过程中的变化情况：
	- **源 IP 地址和目的 IP 地址保持不变**
	- **源 MAC 地址和目的 MAC 地址逐链路（或逐网络）改变**
![image-20231112204042391](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204042391.png)

**例题**
![image-20231112204111510](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204111510.png)
...
![image-20231112203757240](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203757240.png)

- **ARP 请求报文**：只在子网广播发送
![image-20231112203804582](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203804582.png)

- **ARP 响应报文**：单播发送
![image-20231112203810036](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203810036.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714154646.png)
...
- **ARP 过程**：
	...
	- **目的主机不在本局域网**:
		...
		- 剩下的工作交给路由器完成
		![image-20231112203821746](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112203821746.png)
...
- **DHCP**：
	...
	- 提供了即插即用的连网机制
	- 应用层协议，基于 UDP
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714155538.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714160657.png)
- **注意**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172659.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172728.png)

2. **源点抑制**：**当路由器或主机由于拥塞而丢弃数据报时，就向源点发送源点抑制报文**，使源点知道应当把数据报发送速率放慢
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172745.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172815.png)

4. **参数问题**：当路由器或目的主机收到 `IP` 数据报后，根据其首部中的检验和字段发现首部在传输过程中**出现了误码，就丢弃该数据报，并向源点发送参数问题报文**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172834.png)

5. **改变路由**【重定向】：**路由器把改变路由报文发送给主机**，让主机知道下次应将数据报发送给另外的路由器 【可通过更好的路由】
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172910.png)
...
### 1、IPv 6 的主要特点
![image-20231112204206803](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204206803.png)

### 2、IPv6 数据报的首部
- 包括：
	- **基本首部**
	- **有效载荷**：由零个或多个扩展首部【不属于 IPv6 数据报的首部】即其后面的数据部分组成
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714163901.png)

#### （1）IPv6  数据报的基本首部
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714163925.png)
...
- **下一个首部**：长度为 `8` 比特
	...
	![image-20231124192146974](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124192146974.png)
- **跳数限制**：长度为 `8` 比特
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714164147.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714171504.png)

![image-20231112204414599](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204414599.png)

![image-20231112204420261](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204420261.png)

![image-20231124192538175](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124192538175.png)
...
-  **`IPv6`地址分类**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172041.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172056.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172144.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172127.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172205.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172243.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240714172344.png)
...
1. **静态路由算法**【非自适应路由算法】：
	...
	- 一般只在**小规模网络**中采用
![image-20231119142800161](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119142800161.png)
 ![image-20231119143001494](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119143001494.png)
![image-20231119143723325](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119143723325.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715154854.png)
...
![image-20231112205907287](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205907287.png)
- **注意**： 
...
- 允许一条路径最多只能包含 `15` 个路由器：
	...
	- **`RIP` 只适用于小型互联网**
![image-20231112204647738](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204647738.png)
-  `RIP` 认为**好的路由**就是**距离短**的路由，也就是所**通过路由器数量最少的路由**
![image-20231112204723520](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204723520.png)
...
![image-20231112204803684](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204803684.png)
2. 每个路由器**仅和相邻路由器周期性地交换并更新路由信息** 
3. 若干次交换和更新后，每个路由器都知道到达本自治系统 `AS` 内各网络的最短距离和下一跳路由器，称为**收敛**
![image-20231112204820256](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204820256.png)

#### （4）RIP 的距离向量算法
##### 1）基本更新过程
1. C 向 D 发送封装有路由信息的 `RIP` 更新报文
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715163255.png)

2. D 收到 C 的路由表后，对其进行修改 
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715163330.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715164544.png)

3. 根据修改后的 C 的路由表，更新 D 的路由表
![image-20231112204956988](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112204956988.png)
...
#### （5）RIP 的优缺点
![image-20231112205248407](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205248407.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715165556.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715165611.png)
...
#### （7）例题
![image-20231112205304637](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205304637.png)

![image-20231112205312200](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205312200.png)

### 4、开放最短路径优先协议 OSPF
#### （1）基本概念
- **链路状态 `LS`**：指本路由器都和**哪些路由器相邻**，以及**相应链路的代价**【费用、距离、时延、带宽】
![image-20231112205353213](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205353213.png)

- **`Hello` 分组**：
	- 建立和维护邻居关系
	- 封装在 **`IP` 数据报**中，发往**组播地址224.0.0.5**
	- `IP` 数据报首部中的协议号字段的取值为 `89`，表明 IP 数据报的数据载荷为 `OSPF` 分组
    ![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205415726.png)
    - 发**送周期为 `10` 秒**
    - **40 秒**未收到来自邻居路由器的 `Hello` 分组，则认为该邻居路由器不可达
    - 每个路由器都会建立一张**邻居表**
    ![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715172838.png)
...
![image-20231112205504029](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205504029.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715173703.png)
...
+ 当 `DR` 失效时由 `BDR` 顶上
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715174449.png)

#### （6）OSPF 划分区域
- 为了使 OSPF 协议能够**用于规模很大的网络**，OSPF**把一个自治系统 AS 再划分为若干个更小的范围**，称为**区域**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715174632.png)
* 自治系统边界路由器 ASBR：R6
...
#### （7）例题
![image-20231112205709135](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205709135.png)

### 5、边界网关协议 BGP
#### （1）基本概念
- **边界网关协议 BGP**：属于外部网关协议 `EGP` 这个类别，用于**自治系统 AS 之间的路由选择协议**
![image-20231119173358395](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231119173358395.png)
- 使用 BGP 的环境因素：
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715180452.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715180040.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715181103.png)

#### （6）例题
![image-20231112205827554](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112205827554.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240715180323.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716143321.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716143439.png)
- 与 IP 数据报相同，IP 多播数据报也是“**尽最大努力交付**”，不保证一定能够交付给多播组内的所有成员
- IPv 4 多播地址又可分为**预留的多播地址**【永久多播地址】、全**球范围可用的多播地址**以及**本地管理的多播地址**
![image-20231112210758607](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112210758607.png)
- `IP` 多播可分为以下两种：
	1. 只在**本局域网**上进行的**硬件多播**
	2. 在**因特网**上进行的**多播**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716150924.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716151043.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716151115.png)

**举例**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716151438.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716151413.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716152830.png)
...
##### 2）基本工作原理【看湖科大】
1. **加入多播组**
![image-20231112210956020](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112210956020.png)

2. **监视多播组的成员变化**
	- **IGMP 成员查询报文**的内容**可以是 0.0.0.0，表示全部多播组**
	- IP 多播数据报的目的地址：224.0.0.1：**特殊的 IP 多播地址，在本网络中所有参加多播的主机和路由器的网际层都会接受该多播数据报**
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124181326196.png)

![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124181256119.png)
...
3. **退出多播组**
![image-20231112211037069](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112211037069.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716152528.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716155115.png)
...
![image-20231124185143546](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124185143546.png)
...
![image-20231124185233626](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124185233626.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716160658.png)
...
![image-20231124185608452](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124185608452.png)
...
5. **三角形路由问题**
![image-20231124190046553](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231124190046553.png)
- 解决方法：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716163143.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716164112.png)
- **转发表**：
	- 从路由表得出，其表项和路由表项有直接的对应关系
	- **组成**：一个分组将要发往的目的地址、分组的下一跳【下一步接收者的目的地址，实际为 MAC 地址】
	- 可使用一个**默认路由**【优先级比其他项目低】代替所有具有相同“下一跳”的项目，以减少重复项
	- 可以用软件或特殊的硬件实现
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240716164517.png)
