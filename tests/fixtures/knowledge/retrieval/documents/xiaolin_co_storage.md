## 一、存储系统基本概念
### 1. 存储系统的层次结构
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240414161929.png)
...
- 存取周期 = 存取时间 + 恢复时间
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240419130609.png)
...
- 片选线用行通选线替代
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240419131338.png)
- 总容量 = 存储单元个数 * 存储字长
- 常见的描述：8 K × 8 位，即 $2^{13}×8 bit$ = 8 KB
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240419133619.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240419133245.png)

#### （4）主存储器的组成部分
- 数据线的宽度 = MDR 的宽度 = 存储字长
- 地址线的宽度 = MAR 的宽度 = 存储字数
- 下图总容量 = $2^{36}×64$ 位= $2^{39} B$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240419132618.png)
...
| 集成度   | 低                         | 高    |
| 存储成本  | 高                         | 低    |
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420140236.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420140852.png)
**刷新过程**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420141316.png)
**刷新过程**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420141719.png)
**刷新过程**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420144318.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420145257.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420150348.png)
- **启动方式**：
	- 轮流启动方式：
	 ...
	 ![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420150628.png)

	- 同时启动方式：
		- 所有模块一次并行读 / 写的总位数正好等于数据总线位数
		- 同时启动所有模块进行读 / 写
- **计算带宽**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420145345.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420153420.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420152709.png)

#### （2）主存容量的扩展
##### 1）位扩展法
- $8 K* 8 位$ 的存储器 = 8片 $8 K*1 位$ 的 RAM 组成
- 地址线并行，数据线一一接上
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420152941.png)
...
1. **线选法**
	...
	- 2 位二进制时：只能利用 01，10
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420154050.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420154236.png)

**比较**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420154626.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240420154408.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421142222.png)
...
1. CPU、Cache、和主存三者的读写关系
	...
	- CPU 计算完后，会把数据再次返回给 Cache
		【速度也是 5 ns】
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421144023.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421145344.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421145924.png)
**优点**
- 映射灵活
- 块冲突概率比较低
- 空间利用率也高
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421151107.png)
...
- 组内再任意放【组内是全相联映射】
- 所属分组 = 主存块号 % 分组数
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421152651.png)
- Cache 的总块数：$2^c$
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421153556.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421153803.png)

### 3、Cache 替换算法
#### （1）随机算法
- 若Cache已满，则随机选择一块替换
- 实现简单，但完全没考虑局部性原理，命中率低，实际效果很不稳定
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421154132.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421154303.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421154618.png)

#### （4）最不经常使用 LFU
- 只统计使用次数，**用的最少的就替换掉谁**
- 需要硬件设计**计数器**支持
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421154926.png)
...
-  访存次数增加，速度变慢，但更能保证数据一致性
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421160039.png)
...
- 减少了访存次数，但存在数据不一致的隐患
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421155443.png)
...
- 搭配回写法使用
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421160455.png)

##### 2）非写分配法
- 当 CPU 对 Cache 写不命中时只写入主存，不调入 Cache
- 搭配全写法使用
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421160655.png)

#### （3）多级 Cache
- 现代计算机通常采用多级 Cache 结构
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421161037.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240421161105.png)
