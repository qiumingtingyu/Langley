...
![image-20231118141821673](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118141821673.png)
...
![image-20231118142222986](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118142222986.png)

- **数据链路**：
	- 把实现控制数据传输的通信协议的硬件和软件加到链路上
	- 由网络适配器【网卡】和其相应软件驱动程序实现通信协议
	- **一般网卡包含物理层和数据链路层的功能**
![image-20231118142257703](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118142257703.png)

- **链路管理**：数据链路层的建立、维持和释放过程

- **帧**：数据链路层对等实体之间在水平方向进行逻辑通信的**协议数据单元 PDU**
![image-20231112103446745](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112103446745.png)
...
- 组帧主要解决：**帧定界、帧同步、透明传输**等问题
	- 帧头和帧尾中包含有**重要的控制信息**
	![image-20231118142719311](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118142719311.png)
	![image-20231118142736883](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118142736883.png)
	- 帧头和帧尾的作用之一就是**帧定界**
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707162944.png)
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707163149.png)
- **注意**：
...
- **最大传送单元（MTU）**：
	...
	- 以太网的 MTU 为 1500 个字节
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707163800.png)

- **组帧方法**：较常用的是零比特填充法和违规编程法
#### （1）字符计数法
- 在帧首部使用一个计数字段来记录该帧所含的字节数【包括计数字段所占用的 1 个字节】
- **缺点**：如果计数字段出错，就失去了帧定界划分的依据
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707170241.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707170813.png)
...
- 早期使用的 HDLC 协议采用这种方法
- 很容易用硬件实现，性能优于字符填充法
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707171504.png)
...
![image-20231118143645931](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118143645931.png)

- 面向比特的物理链路使用**比特填充**的方法
![image-20231118143716167](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118143716167.png)
...
![image-20231118144436178](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118144436178.png)

![image-20231118144449748](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118144449748.png)
- **注意**：
...
- **除法内的相减实际是做异或运算**
![image-20231112104000229](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104000229.png)

![image-20231112104006839](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104006839.png)

![image-20231112104015119](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104015119.png)

![image-20231112104022454](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104022454.png)
...
- **检错 d 位，需要码距 d+1 的编码**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240707175424.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708145341.png)
- **接收窗口 $W_R$**：
	- 接收方维持一组连续的允许接收帧的序号
	- 控制可以接收哪些帧和不可以接收哪些帧
	- $W_R = 1$： 接收方每收到一个序号落入窗口的数据帧，就允许将该帧收下，然后将接受窗口向前滑动一个位置，并发回确认
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708145416.png)
...
![image-20231118152619734](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118152619734.png)
- **自动重传请求（ARQ）**：
	...
	- 分类：
		...
		2. 后退 N 帧 ARQ (GBN)
		3. 选择重传 ARQ (SR)
![image-20231112105036035](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112105036035.png)
...
![image-20231112104230883](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104230883.png)
...
![image-20231118153009395](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118153009395.png)

- **对数据帧编号**：
	- 避免**分组重复**的传输错误
	- 对于 SW 协议，每次发送一个数据分组就停止等待，只需一个比特来编号【0 / 1】
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708153024.png)

- **对确认帧编号**：
	- 避免**确认分组迟到**的情况【数据链路层一般不会出现】
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708154012.png)

- **信道利用率**：
$$
U=T_D/T_D+RTT+T_A
$$
![image-20231112104346528](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104346528.png)

![image-20231118153705266](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118153705266.png)
- 若出现超时重传，对于传送有用的数据信息来说，信道利用率还要降低
- 在往返时间 RTT 相对较大的情况下，为了提高信道利用率，收发双方不适合采用停止-等待协议，而可以选择使用回退 N 帧（GBN）协议或选择重传（SR）协议
##### 例题
![image-20231118154233007](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118154233007.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708164533.png)
...
* GBN 协议允许接收方进行**累计确认**：
	...
	* **缺点**：不能及时反映出确认分组的信息
![image-20231112104538143](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104538143.png)

![image-20231112104544672](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104544672.png)

![image-20231112104553737](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112104553737.png)
##### 2）有差错情况
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708161601.png)

##### 3）窗口尺寸的限制
$$
帧序列号=n位时，发送窗口W_T<=2^n-1,接收窗口=1
$$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708162057.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708162114.png)
- 此时，**无法分辨新旧数据分组**
##### 4）总结
![image-20231118155600707](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118155600707.png)

##### 5）例题
![image-20231118155848852](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118155848852.png)
...
- 接收方设置足够的**帧缓冲区**：
	...
	- 数目等于接收窗口的大小
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240708163203.png)

![image-20231118160427547](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118160427547.png)
##### 例题
![image-20231118160447094](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118160447094.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709150323.png)

#### （1）频分复用 FDM
- 将信道的总频带划分为多个子频带，每个子频带作为一个子信道，每对用户使用一个子信道进行通信
- 所有用户在同一时间占用不同的频带资源
- **优点**：充分利用了传输介质的带宽，系统效率较高，实现也比较容易
![image-20231118134833866](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118134833866.png)
...
- **统计时分复用（STDM）**：
	...
	- 又称：异步时分复用
![image-20231118135020693](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118135020693.png)

#### （3）波分复用 WDM
- 基于光的频分复用
- 在一根光纤中传输多种不同波长（频率）的光信号，因为波长不同，各路光信号互不干扰，最后用光分用器将各路波长分解出来
- 因为光波处于频谱的高频段，有很大的带宽，所以可以实现多路的波分复用
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709150836.png)
...
![image-20231118140909856](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118140909856.png)

**举例**
![image-20231118140942981](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118140942981.png)

![image-20231118141122448](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118141122448.png)

![image-20231118141146348](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118141146348.png)

![image-20231118141252270](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118141252270.png)
...
- 吞吐量很低
![image-20231112110006059](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112110006059.png)

##### 2）时隙 ALOHA 协议
- 同步各站点的时间，将时间划分为一段段等长的**时隙**$T_0$
- 规定站点只能在每个时隙开始时才能发送帧，发送一帧的时间必须小于或等于时隙的长度
- **优点**：避免了用户发送数据的随意性，降低了产生冲突的可能性，提高信道利用率
![image-20231112110024484](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112110024484.png)
...
- **CSMA/CD**：
	...
	- **不能完全避免碰撞**
	- 先听后发，边听边发，冲突停发，随机重发
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118173537076.png) 
- **帧间最小间隔**: 
	- `96` 比特时间，指发送 `96` 比特所需要的时间
	- 作用：接收方可以检测出一个帧的结束，同时也使得其他站点都能有机会平等竞争信道并发送帧
![image-20231112110214462](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112110214462.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118195058407.png)

![image-20231112110253739](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112110253739.png)
...
![image-20231112111402734](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112111402734.png)
...
![image-20231118200700864](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118200700864.png)
...
![image-20231118200953850](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118200953850.png)
- 使用上述退避算法可**使重传需要推迟的平均时间随重传次数而增大**（即**动态退避**），因而**减小产生碰撞的概率**
- **当重传达 16 次仍不能成功时**，就表明同时打算发送帧的站点太多，以至于连续产生碰撞，此时应**放弃重传**并向高层报告

##### 5）信道利用率
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709170134.png)
- 考虑以下这种理想情况：
	+ 各站点发送帧都不会产生碰撞
	+ 总线一旦空闲就有某个主机立即发送帧
...
##### 6）例题
![image-20231112113157377](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113157377.png)

![image-20231112113205342](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113205342.png)

![image-20231112113217266](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113217266.png)
...
- 无线局域网中的问题：
	...
	![image-20231118202917032](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118202917032.png)
- **CSMA/CA**：
	- 载波监听多路访问/冲突避免
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709171459.png)
...
- **发现信道忙后，等待了 DIFS 时间后，还要退避一段随机时间**：
	...
	- 因此需要一个随机时间将他们进行错峰发送
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709172440.png)
...
![image-20231112112907219](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112112907219.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240709174322.png)
- **注意**：
...
> ![image-20231112113506252](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113506252.png)
...
![image-20231118214756420](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118214756420.png)

![image-20231118171539676](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118171539676.png)
...
![image-20231118171903795](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118171903795.png)
- MAC 地址一般被固化在网卡的电可擦可编程只读存储器 EEPROM 中，因此 MAC 地址也被称为**硬件地址**
- MAC 地址有时也被称为**物理地址**
![image-20231118172056275](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118172056275.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118172402789.png)

![image-20231118172613497](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118172613497.png)
...
- **注意**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240710152104.png)
...
- **检验码（FCS）**： 4 字节，算法采用 32 位 CRC 码，
	...
	- **不检验前导码**
![image-20231112113824286](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113824286.png)
...
![image-20231112113917696](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113917696.png)

- **扩展的服务集 ESS**：
	- 通过 AP 连接到一个**分配系统 DS**，然后再连接到另一个服务集
	- 分配系统的作用就是使扩展的服务集对上层的表现就像一个基本服务集一样
	- ESS 还可以通过 Portal（门户）设备为无线用户提供到有线连接的以太网的接入，**门户的作用相当于一个网桥**
![image-20231112113940932](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113940932.png)
- **注意**：AP1 到 AP2 的通信使用有线传输

##### 2）无固定基础设施（自组织网络）
- **自组织网络没有 AP**，而是由一些平等状态的移动站相互通信组成的临时网络
- 各结点地位平等，**中间节点都为转发结点，因此都具有路由器的功能**
![image-20231112113955143](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112113955143.png)
- 自组网络和移动 IP 并不相同：
...
![image-20231112114014196](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114014196.png)
- 802.11 帧分三种：
	1. **数据帧**：用于在站点间的传输
	2. **控制帧**：
		- 通常与数据帧搭配使用
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240710165249.png)
...
![image-20231112114050129](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114050129.png)

- **发送数据帧的情况**：
	1. A->B
	![image-20231112114102074](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114102074.png)
	
	2. A->R（路由器接口）：802.11 MAC 帧需要通过 AP 转为 802.3 帧
	![image-20231112114113363](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114113363.png)

- **例题**：
![image-20231112114139501](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114139501.png)
...
![image-20231112114152975](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114152975.png)
...
>
> ![image-20231112114204848](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114204848.png)

- **分割广播域的方法**：
	1. 使用**路由器**：
		- 由于路由器默认情况下不对广播数据包进行转发，因此路由器很自然的就可以隔离广播域
		- 成本很高，全部使用路由器隔离广播域是不现实的
	![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118215908627.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118220257281.png)
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/202305100847412.png)
- **注意**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240710172009.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240711145921.png)
...
![image-20231112114440220](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114440220.png)

#### （2）PPP 链路的连接过程
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240711160121.png)

#### （3）PPP 帧格式
- 首部和尾部各有一个**标志字段 F**，规定为 0x7E（01111110），作为帧定界符，表示帧的开始和结束
![image-20231112114525637](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114525637.png)
- **注意**：
	- PPP 是点对点的，并不是总线形，所以不用 CSMA/CD 协议，自然就没有最短帧，所以**数据部分是 0-1500B**

#### （4）PPP 帧实现透明传输
![image-20231118165502886](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118165502886.png)
##### 1）面向字节的异步链路使用字节填充法
- 发送方处理：
...
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118170205169.png)
...
![image-20231118170229537](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118170229537.png)

#### （5）PPP 帧实现差错检测
![image-20231118170503663](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118170503663.png)
...
* 网桥具有**识别帧和转发帧**的能力：
	...
	* 起到了过滤通信量的功能
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240711163109.png)


#### （2）主要结构和基本工作原理
- **转发表是网桥转发帧的依据**：记录各个主机的 MAC 地址与自己各接口的对应关系
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240711163236.png)

- **网桥转发和丢弃帧**：
![image-20231112114652716](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114652716.png)

- **网桥转发广播帧，是不查转发表的**
![image-20231112114733974](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114733974.png)
...
![image-20231112114757412](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114757412.png)

![image-20231112114803125](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114803125.png)

![image-20231112114809001](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114809001.png)
- **注意**：
	* 如果网桥收到**有误码的帧则直接丢弃**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240711163521.png)
...
![image-20231112114839986](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114839986.png)
...
![image-20231118213732175](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118213732175.png)
...
- 交换机**每个接口是一个独立的冲突域**
![image-20231112114923881](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114923881.png)

#### （3）交换机自学习和转发帧流程（参考网桥）
![image-20231112114943180](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112114943180.png)
...
- 具体内容见湖科大 ppt
![image-20231112115200250](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115200250.png)

![image-20231112115208812](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115208812.png)
...
![image-20231112115335378](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115335378.png)
...
- **广播帧**：
	...
	- **交换式以太网，交换机工作在数据链路层**：
		...
		- 其他主机收到该广播帧后，就接收
![image-20231112115355033](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115355033.png)

- **多主机同时通信**：
	- **共享式以太网**：必然产生冲突
	- **交换式以太网**：交换机能实现多对接口的高速并行交换，不会冲突
![image-20231112115413874](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115413874.png)

- **使用集线器和交换机扩展共享式以太网的区别**：
	- 集线器既扩大了广播域又扩大了冲突域
	- 交换机扩大了广播域，隔离了冲突域
![image-20231112115432824](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115432824.png)

#### （7）例题
![image-20231112115445598](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115445598.png)

![image-20231112115454402](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115454402.png)

![image-20231112115500591](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115500591.png)

![image-20231112115310168](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115310168.png)

![image-20231112115317361](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115317361.png)

![image-20231112115323080](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112115323080.png)
