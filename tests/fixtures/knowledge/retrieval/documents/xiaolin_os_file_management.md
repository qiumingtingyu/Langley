...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240519145726.png)
- FCB 主要包含以下信息：
...
- 内存中**文件的系统结构**：
	...
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240519155554.png)
...
- **精简的访问控制列表**：
	- 解决 ACL 的问题，包含三种用户类型：
		...
		- **其他**：系统内的所有其他用户
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240519163103.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525155737.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525160520.png)
- 检索效率分析：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525160652.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525170229.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525170710.png)
...
- **缺点**：
	- 文件分配表的需要占用一定的存储空间
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525171646.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525173851.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525174427.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240525175037.png)
...
- **缺点**：
	...
	- 对于多用户的操作系统不适用
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526160628.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526160843.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526163436.png)
...
- **优点**：实现了文件共享
- **缺点**：使得系统管理变得更加复杂
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526164150.png)
...
- **特点**：
	- 不可用于跨文件系统
	- 查找速度比软链接快
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526170945.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526171604.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526173040.png)
...
- **逻辑文件系统**：
	...
	- 通过 FCB 维护文件结构
	- 负责文件保护
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240526175805.png)
...
- 每个分区中有一个独立的文件系统
- 文件系统可能包含如下信息：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527192819.png)
- **主引导记录（MBR）**：
	- 位于磁盘的 0 号区，用来引导计算机
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527201721.png)
...
- 每个空闲区对应一个**空闲表项**，包括：
	...
	- 该空闲区的空闲盘块数
- 按起始盘块号递增的次序对空闲区排列
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527201856.png)
- **如何分配磁盘块**：
...
- **缺点**：
	...
	- 以盘块为单位，链会很长
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527202717.png)
...
- **缺点**：是分配与回收的过程比较复杂
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527203008.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527203347.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527212600.png)

### 4、虚拟文件系统
- **虚拟文件系统（VFS）**：屏蔽了不同文件系统的差异和操作细节，向上为用户提供了文件操作的同一调用接口
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527214116.png)
- **特点**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240527214800.png)
