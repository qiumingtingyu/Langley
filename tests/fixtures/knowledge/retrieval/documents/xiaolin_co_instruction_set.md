...
- 指令的地址由程序计数器给出
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240422215027.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240422220641.png)

#### （4）指令地址码
##### 1）零地址指令
只给出操作码 OP，没有显示地址
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423175431.png)
1. 不需要操作数的指令：空操作指令，停机指令，关中断指令
2. 堆栈计算机，两个操作数来自堆栈的栈顶和次栈顶单元

##### 2）一地址指令
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423180024.png)
1. 只有目的操作数的单操作数指令：
	- OP ($A_1$) -> $A_1$
	- 自增、自减、取反、求补
...
##### 3）二地址指令
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423175953.png)
- ($A_1$) OP ($A_2$) -> $A_1$
- 常用于需要两个操作数的算术运算、逻辑运算相关指令
- 完成一条指令需要 4 次访存（取指 -> 读 $A_1$ -> 读 $A_2$ -> 写 $A_1$）

##### 4）三地址指令
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423175606.png)
- 常用于需要两个操作数的算术运算、逻辑运算相关指令
-  ($A_1$) OP ($A_2$) -> $A_3$
- 完成一条指令需要 4 次访存（取指 -> 读 $A_1$ -> 读 $A_2$ -> 写 $A_3$）

##### 5）四地址指令
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423180042.png)
...
- 零地址指令为 16 条
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240423182012.png)
**设计原则**
...
2. **跳跃寻址**：通过转移类指令（如相对寻址）实现，可用来实现程序的条件或无条件转移
	...
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426161519.png)
...
- 地址码 = 寻址特征 + 形式地址
	...
	![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426162040.png)
...
- **有效地址**：由程序指定
**![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426162929.png)
- **优点**：有利于缩短指令字长
- **缺点**：需增加存储操作数或隐含地址的硬件
##### 2）立即寻址
...
- **有效地址**： A 就是操作数，也称**立即数**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426163316.png)
...
- **有效地址**：EA = A
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426164012.png)
...
- **有效地址**：EA = (A)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426164713.png)
...
- **寻址过程**：访问该寄存器，取出操作数
- **有效地址**：EA = $R_i$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426165653.png)
...
- **有效地址**：EA = $(R_i)$
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426181955.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426183205.png)
- **优点**：
...
- **变址寄存器**：
	...
	- 形式地址 A 不变（作为基地址）
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426183710.png)
- **优点**：
...
- A 的位数决定操作数的寻址范围
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426185023.png)
- **优点**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426185925.png)

#### （4）对比
- 速度方面：立即寻址 > 寄存器寻址 > 直接寻址 > 寄存器间接寻址 > 间接寻址
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240426190806.png)
