...
## 一、传输层概述
### 1、基本概念
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112211434828.png)
- **物理层、数据链路层以及网络层**它们共同解决了将主机通过异构网络互联起来所面临的的问题，**实现了主机到主机的通信**
- 实际上在**计算机网络中进行通信的真正实体是位于通信两端主机中的进程**
- 为运行在不同主机上的**应用进程提供直接的通信服务是传输层的任务**
- 传输层协议又称端到端协议
![image-20231112211504435](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112211504435.png)

### 2、传输层的功能
#### （1）应用进程之间的通信
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112212642802.png)

#### （2）复用和分用
- **复用**：发送方不同的应用进程都可以使用同一传输层协议**传输数据**
- **分用**：接收方的传输层在剥去报文的首部之后能够把这些**数据正确交付到目的应用进程**
![image-20231112212729630](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112212729630.png)

![image-20231112212738803](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112212738803.png)
- **注意**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240718144059.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240718151025.png)
...
![image-20231112213036420](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112213036420.png)
...
- 端口号使用**16 比特**表示，取值范围 `0~65535`，根据端口号范围将端口分为两类：
	1. **服务端使用端口号**：
		...
		![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240718150249.png)
...
- UDP 数据报包含两部分：
	- **首部**：8 B
	- **数据部分**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240719165719.png)
- **源端口和目的端口**：
	- UDP 分用：基于目的端口
	- UDP 复用：基于源端口
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240719170518.png)
- **校验过程**：
	- **将校验和字段置位 0**
	- 将伪首部和 UDP 用户数据报【首部和数据部分】看成是以 16 位为单位的二进制组成，依次进行**二进制反码求和**
	- 将求和的**结果的反码写入校验和字段**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240719170852.png)
- **注意**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240719174307.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720153707.png)
...
**过程**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720143236.png)
1. **第一次握手**：
...
![image-20231125183650330](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231125183650330.png)

**例题**
![image-20231112214125483](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214125483.png)

![image-20231112214131362](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214131362.png)

#### （2）TCP 连接释放（四次挥手）
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720151307.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720153322.png)

- **TCP 保活计时器的作用**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720153439.png)


**例题**
![image-20231112214257037](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214257037.png)

![image-20231112214302825](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214302825.png)

![image-20231112214557534](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214557534.png)

![image-20231112214605097](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214605097.png)

![image-20231112214611034](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214611034.png)
...
![image-20231112214006145](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214006145.png)

- **使用三个指针 P1、P2、P3 分别指向相应的字节序号**：
	- P1 指向发送窗口内已发送但还未收到确认的第一个数据的序号
	- P2 指向发送窗口内还未发送的第一个数据的序号
	- P3 指向发送窗口前沿外的第一个数据的序号
![image-20231112214012014](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214012014.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720172630.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720170443.png)

#### （2）确认
- TCP 首部的**确认号是期望收到对方的下一个报文段的数据的第一个字节的序号**
- TCP **默认使用累计确认**，即 TCP 只确认数据流中至第一个丢失字节为止的字节
- TCP 可以使用选择确认【SACK】
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720171710.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720171728.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720170932.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720171201.png)

- **往返时间测量问题**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720171230.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720171303.png)
...
#### （4）检验
![image-20231112214531311](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214531311.png)

![image-20231112214536311](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214536311.png)

![image-20231112214544518](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214544518.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720161701.png)
...
![image-20231112213552925](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112213552925.png)

- **持续计时器**：只要 TCP 连接的一方收到对方的零窗口通知，就启动
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720162357.png)

- **若发送的零窗口探测报文也丢失了，是否会造成新死锁

> 不会，因为零窗口探测报文也有超时重传机制
>![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720162837.png)

**例题**
![image-20231125191811976](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231125191811976.png)

### 6、TCP 拥塞控制
#### （1）基本概念
- **拥塞**：在某段时间，若**对网络中某一资源的需求超过了该资源所能提供的可用部分，网络性能就要变坏**
- 若**出现拥塞而不进行控制**，整个网络的**吞吐量将随输入负荷的增大而下降**
![image-20231125192025996](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231125192025996.png)
...
- **衡量网络拥塞的指标**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720163839.png)
...
![image-20231112213614760](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112213614760.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720165025.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720165337.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720165706.png)

#### （4）例题
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720184916.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720184950.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720185014.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720185047.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240720185106.png)
