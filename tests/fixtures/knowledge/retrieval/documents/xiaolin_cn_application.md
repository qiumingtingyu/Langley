...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724194703.png)

## 一、网络应用模型
### 1、应用层概述
- 应用层是计算机网络体系结构的**最顶层**，是**设计和建立见算计网络的最终目的**
![image-20231112214630288](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231112214630288.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240721142539.png)
- **C/S 主要特征**：
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240721144456.png)
- **主要特点**：
...
- **域**：名字空间中一个可被管理的部分
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722140633.png)
...
![image-20231113184628372](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113184628372.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722141950.png)

#### （1）根域名服务器
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722142032.png)

#### （2）顶级域名服务器
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722142057.png)

#### （3）权限域名服务器（授权域名服务器）
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722142116.png)

#### （4）本地域名服务器
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722142139.png)
...
#### （1）递归查询
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722143235.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722143314.png) 
...
**例题**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722143406.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240722143431.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240723145254.png)
#### （1）控制连接
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240723151223.png)


**例题**
![image-20231113185103725](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185103725.png)

![image-20231113185112246](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185112246.png)
...
- 电子邮件系统的三个主要组成构件：**用户代理，邮件服务器，以及电子邮件所需的协议**
	...
	- **协议**：
		...
		- 邮件**读取协议**：
			- 用于用户代理从邮件服务器读取邮件
			- 如 POP3，IMAP
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724155739.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724161301.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724161529.png)


**例题**
![image-20231113185306577](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185306577.png)

![image-20231113185317601](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185317601.png)

![image-20231113185325419](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185325419.png)

![image-20231113185332893](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231113185332893.png)
...
- **SMTP 通信过程**：
	...
	2. 邮件发送
	3. 连接释放
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724162432.png)
- 详细过程见王道 P281
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724194841.png)
...
- 仅在不同邮件服务器之间传送用 SMTP
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724165438.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724172419.png)
...
- 最后，TCP 连接释放
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724173039.png)
...
- Cookie 保存在浏览器【客户端】
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724175614.png)
...
|                   | 非持续连接                                                                                       | 持续连接                                                                                        |
| ----------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| **示意图**           | ![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724180441.png)<br> | ![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724180411.png)<br> |
...
- 两类 HTTP 报文：
	- **请求报文**：从客户向服务器发送的请求报文
	- **响应报文**：从服务器到客户的回答
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724174931.png)
- **报文组成**：
	- 开始行：请求行/状态行
	- 首部行
	- 实部主体
...
- **请求报文中的方法**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724175229.png)

- **请求报文实例**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724180019.png)

- **响应报文中的状态码**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724175402.png)

- **响应报文常见状态行**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240724175504.png)
