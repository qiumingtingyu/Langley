...
- 数据通信系统主要划分为三部分：
	...
	- **信道**：信号的传输介质
	- **信宿**：接收数据的终点
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240702152302.png)
- **信道分类**：
	- 按传输信号：
		- 模拟信道用于传输模拟信号
		- 数字信道用于传输数字信号
...
![image-20231114225112924](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114225112924.png)
...
![image-20231114230036714](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114230036714.png) 
...
![image-20231114230058998](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114230058998.png)
...
- **全双工通信**：
	- 通信双方可同时发送或接收信息
	- 需要两个信道
![image-20231114230130084](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114230130084.png)
#### （4）速率、波特与带宽
...
#### 例题
![image-20231111205651840](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111205651840.png)

![image-20231111205703046](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111205703046.png)

![image-20231111205715963](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111205715963.png)


### 3、编码与调制
- **编码**：将数据转换成数字信号的过程
- **调制**：将数据转换成模拟信号的过程
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240702165230.png)
 ![image-20231111205729558](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111205729558.png)

#### （1）数字数据编码为数字信号
- 数字数据编码用于基带传输中，即在基本不改变数字数据信号频率的情况下，直接传输数字信号
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240702175307.png)
...
![image-20231118104902196](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118104902196.png)

##### 2）非归零（NRZ）编码
- 与 RZ 编码的区别是不用归零
- 一个时钟全部用来传输数据，编码效率最高
- 收发双方存在同步问题，需要双方都带有时钟线
![image-20231118104739447](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118104739447.png)
...
- 标准以太网采用
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240702175053.png)
...
- 数据的表示在于每个码元开始处是否有电平跳变：
	...
	- 有跳变表示 0
- 抗干扰能力更强
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240702175152.png)
...
![image-20231111205751233](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111205751233.png)
...
![image-20231118110834113](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118110834113.png)
...
![image-20231118135226109](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231118135226109.png)
...
- 传输媒体并不包含在计算机网络体系结构中
![image-20231114224357737](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114224357737.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240703170951.png)
...
- **优缺点**：
	...
	- 被广泛用于传输较高速率的数据
	- 传输距离比双绞线更远，价格也更高
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240703171356.png)
...
![image-20231114224749968](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231114224749968.png)

- **原理**：基于全反射，当光纤碰到包层时就会折射到纤芯，这个过程不断重复，光就沿着光纤传输下去
![image-20231111210804129](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111210804129.png)

- **分类**：
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240703171517.png)
...
### 2、非导向传输介质
![image-20231111210911271](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111210911271.png)

![image-20231111210920821](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20231111210920821.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240703174251.png)
...
- **注意**：
	...
	- 集线器是**半双工模式**，收发不能同时进行
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240703175928.png)
