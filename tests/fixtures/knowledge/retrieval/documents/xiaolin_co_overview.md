...
### 2. 硬件的发展
![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413143959.png)
...
### 1. 计算机硬件的基本组成
#### （1）冯诺依曼结构
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413143929.png)
**特点：**
1. 采用"存储程序"的工作方式
...
4. 指令和数据均以**二进制代码**表示
	...
	- 数据由指令的地址码给出
	![](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240906171930.png)
5. **指令 = 操作码 + 地址码**
	- 操作码用来表示操作的性质
	- 地址码用来表示操作数在存储器中的位置
6. 指令在存储器内**按顺序**存放
...
#### （2）现代计算机结构
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413144856.png)
**特点：**
1. **以存储器为核心**
2. **计算机** = 主机 + 输入/输出设备
3. **主机** = CPU + 主存
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413150207.png)
**相关概念：**
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413152721.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413152732.png)
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413154040.png)
...
- CU：控制单元，分析指令，给出控制信号
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413153555.png)
...
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413154445.png)
- CPU：中央处理器
- PC：程序计数器
- MAR：存储器地址寄存器
- ALU：算术逻辑部件
...
6. 送结果到寄存器中或者送到内存
7. PC 加一  
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413154635.png)

#### （3）计算机的工作过程
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155130.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155200.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155227.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155310.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155330.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155354.png)

![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413155412.png)
...
## 四、计算机系统的层次结构
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413162637.png)
...
### 1. 从 c 语言源程序到可执行文件
**预处理 -> 编译 -> 汇编 -> 链接**
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413182437.png)
- hello. c：源程序（文本）
- hello. i：修改了的源程序（文本）
- hello. s：汇编程序（文本）
...
### 2. “存储程序”工作方式
![image.png](https://cdn.jsdelivr.net/gh/LYuYang61/Notes-Images@main/408/20240413183223.png)
